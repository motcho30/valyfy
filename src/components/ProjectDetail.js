...
import { Check, Copy, Zap, History, GripVertical, Palette, ArrowRight, Plus, Bot, AlertTriangle, Users, Download, RefreshCw, CheckSquare, Star, Edit3, Trash2, Filter, Search, Grid, List, Settings, TrendingUp, Clock, Tag, Calendar, Eye, EyeOff, Sparkles, BarChart3, Target, Award } from 'lucide-react';
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="group bg-white rounded-2xl border border-slate-200/70 p-6 flex flex-col items-center justify-start text-center relative hover:shadow-lg hover:-translate-y-1 transition-all duration-200" style={{ minHeight: '280px' }}>
              ...
              <h3 className="font-semibold text-slate-800 text-lg mb-2">Lovable</h3>
              <p className="text-sm text-slate-500 mb-6 flex-grow">
                Build your webapp with Lovable's AI-powered development platform
              </p>
...
${project.selectedDesign.prompt}`;
                      ...
                      // Add the Lovable-specific prefix
                      const lovablePrompt = `Building me the following webapp using the PRD and design specs provided:\n\n${combinedContent}`;
                      
                      await navigator.clipboard.writeText(lovablePrompt);
                      showCopyFeedback('lovable');
                    } catch (error) {
                      console.error('Failed to copy to clipboard:', error);
                    }
                  }}
                  className={`w-full font-semibold py-3 px-4 rounded-xl transition-all duration-200 ${
                    copyFeedback.lovable 
                      ? 'bg-green-600 text-white' 
                      : 'bg-slate-900 text-white hover:bg-slate-800'
                  }`}
                >
                  {copyFeedback.lovable ? '✓ Copied!' : 'Copy Prompt'}
                </button>
                <button 
                  onClick={() => setShowUsageModal('lovable')}
                ...
                >
                  How do I use this prompt in Lovable?
                </button>
              </div>
            </div>
            ...
            <div className="group bg-white rounded-2xl border border-slate-200/70 p-6 flex flex-col items-center justify-start text-center relative hover:shadow-lg hover:-translate-y-1 transition-all duration-200" style={{ minHeight: '280px' }}>
              ...
              <h3 className="font-semibold text-slate-800 text-lg mb-2">Cursor</h3>
              <p className="text-sm text-slate-500 mb-6 flex-grow">
                Use Cursor AI to build your webapp with intelligent code assistance
              </p>
              <div className="space-y-3 w-full">
                <button 
                  onClick={async () => {
...
${project.selectedDesign.prompt}`;
                      ...
                      // Add the Cursor-specific prefix
                      const cursorPrompt = `Building me the following webapp using the PRD and design specs provided:\n\n${combinedContent}`;
                      
                      await navigator.clipboard.writeText(cursorPrompt);
                      showCopyFeedback('cursor');
                    } catch (error) {
                      console.error('Failed to copy to clipboard:', error);
                    }
                  }}
                ...
                >
                  {copyFeedback.cursor ? '✓ Copied!' : 'Copy Prompt'}
                </button>
                <button 
                  onClick={() => setShowUsageModal('cursor')}
                  className="w-full bg-white border border-slate-200 text-slate-700 font-semibold py-2 px-4 rounded-xl hover:bg-slate-50 hover:border-slate-300 transition-all duration-200 text-sm"
                >
                  How do I use this prompt in Cursor?
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-2xl p-8 max-w-md w-full mx-4 shadow-xl">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <h4 className="font-semibold text-sm text-gray-900">Open Cursor Settings</h4>
                      <p className="text-sm text-gray-600">Go to Cursor Settings → Rules</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    ...
                    <div className="flex-1">
                      <h4 className="font-semibold text-sm text-gray-900">Add new project rules file</h4>
                      <p className="text-sm text-gray-600">Click "Add new project rules file"</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    ...
                    <div className="flex-1">
                      <h4 className="font-semibold text-sm text-gray-900">Create PRD file</h4>
                      <p className="text-sm text-gray-600">Name it "prd" and paste the copied content</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    ...
                    <div className="flex-1">
                      <h4 className="font-semibold text-sm text-gray-900">Prompt Cursor</h4>
                      <p className="text-sm text-gray-600">Ask Cursor to build your webapp using the rules file</p>
                      <div className="mt-2 p-3 bg-gray-50 rounded-lg border border-gray-200">
                        <p className="text-xs text-gray-700 font-mono">
                          "Build me my webapp following the PRD and design specs in @prd"
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-2">
                        <h4 className="font-semibold text-sm text-gray-900">Go to Lovable</h4>
                        <button 
                      ...
                      <p className="text-sm text-gray-600">Open Lovable in your browser</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-6 h-6 bg-pink-600 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">Paste the copied prompt into Lovable's interface</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-6 h-6 bg-pink-600 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
              ...
              <div className="mt-6 pt-4 border-t border-gray-100">
                <button 
                  onClick={() => setShowUsageModal(null)}
                  className="w-full bg-gray-900 text-white font-semibold py-3 px-4 rounded-xl hover:bg-gray-800 transition-all duration-200"
                >
                  Got it
                </button>
              </div>
...
const ProjectPromptTemplates = ({ project, availableFeatures }) => {
  ...
  const savePrompt = async (promptData) => {
    ...
    if (!project?.id || project.id.toString().startsWith('local-')) {
      // Save to localStorage for local projects
      const existingPrompts = JSON.parse(localStorage.getItem(`promptManagement_${project?.id}`) || '[]');
      
      // Check if this is an update to an existing prompt
      const existingIndex = existingPrompts.findIndex(p => p.id === newPrompt.id);
      
      if (existingIndex !== -1) {
        // Update existing prompt
        existingPrompts[existingIndex] = newPrompt;
      } else {
        // Add new prompt
        existingPrompts.push(newPrompt);
      }
      
      localStorage.setItem(`promptManagement_${project?.id}`, JSON.stringify(existingPrompts));
      setSavedPrompts(existingPrompts);
      return;
    }
    ...
    try {
      ...
      if (newPrompt.id && newPrompt.id !== 'new') {
        // Update existing prompt
        await saveGeneratedFile(project.id, {
          fileName: `${newPrompt.name.replace(/\s+/g, '-')}-prompt.md`,
          fileType: 'Prompt Template',
          content: newPrompt.content,
          metadata: metadata,
          fileId: newPrompt.id // Pass the existing file ID
        });
      } else {
        // Create new prompt
        await saveGeneratedFile(project.id, {
      ...
      // Reload prompts for this component
      const files = await getProjectFiles(project.id);
      const promptFiles = files.filter(f => f.type === 'Prompt Template').map(f => ({id: f.id, feature: f.metadata?.feature || f.name.replace('-prompt.md', '').replace(/-/g, ' '), content: f.content, createdAt: f.createdAt})).sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt));
      setSavedPrompts(promptFiles);
    } catch (error) {
  ...
  return (
    <div className="p-4 sm:p-6 md:p-8 bg-white">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-1">Generate new prompts and manage your existing ones</p>
      </div>
      ...
      <div className="mb-12">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h3 className="text-xl font-semibold text-gray-900">Prompt Generator</h3>
            <p className="text-gray-600 text-sm">Select or drag a feature to generate a detailed prompt</p>
          </div>
        </div>
        ...
        <PromptGeneratorView 
          ...
          setAddFeatureModalOpen={setAddFeatureModalOpen}
          newFeatureName={newFeatureName}
          setNewFeatureName={setNewFeatureName}
          ...
          savedPromptsRef={savedPromptsRef}
          handleSavedPromptClick={handleSavedPromptClick}
...
// Prompt Generator View Component
    ...
    <>
      <div className="flex justify-end mb-6">
        <div className="relative" ref={savedPromptsRef}>
          <button onClick={() => setShowSavedPrompts(!showSavedPrompts)} className="flex items-center space-x-2 px-4 py-2 bg-white border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors">
          ...
          {showSavedPrompts && (
            <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="absolute top-full right-0 mt-2 w-80 bg-white rounded-lg shadow-lg border z-10">
              <div className="p-3 border-b">
                <h4 className="font-semibold">Saved Prompts</h4>
              </div>
              <div className="p-2 max-h-96 overflow-y-auto">
                {savedPrompts.length > 0 ? savedPrompts.map((prompt) => (
                  <button key={prompt.id} onClick={() => { handleSavedPromptClick(prompt); setShowSavedPrompts(false); }} className="w-full text-left p-2 rounded-md hover:bg-gray-100">
                    <div className="font-medium text-sm">{prompt.feature}</div>
                    <p className="text-xs text-gray-500 truncate">{prompt.content}</p>
                  </button>
                )) : (
                  <div className="p-4 text-center text-sm text-gray-500">No saved prompts yet.</div>
                )}
              </div>
            </motion.div>
          )}
        ...
        <div className="flex flex-wrap gap-3">
          {features.map((feature, index) => (
            <motion.div 
              ...
              title="Click or drag to generate" 
              className={`flex items-center space-x-2 px-4 py-2 rounded-full cursor-grab transition-all ${selectedFeature === feature ? 'bg-gray-800 text-white' : 'bg-white border border-gray-200'}`}
            >
...
// Prompt Management System Component
const PromptManagementSystem = ({ project, availableFeatures }) => {
  const { saveGeneratedFile, getProjectFiles, loading: filesLoading } = useProjectFiles();
  ...
  const loadPrompts = async () => {
    if (!project?.id || project.id.toString().startsWith('local-')) {
      // Load from localStorage for local projects
      const storedPrompts = JSON.parse(localStorage.getItem(`promptManagement_${project?.id}`) || '[]');
      setPrompts(storedPrompts);
      return;
    }

    try {
      const loadedPrompts = await promptManagementService.getPrompts(project.id);
  ...
  const savePrompt = async (promptData) => {
    ...
    try {
      if (promptData.id && promptData.id !== 'new') {
        // Update existing prompt
        const updatedPrompt = await promptManagementService.updatePrompt(promptData.id, {
        ...
        // Update local state
        setPrompts(prev => prev.map(p => p.id === promptData.id ? updatedPrompt : p));
      } else {
        // Create new prompt
        const newPrompt = await promptManagementService.createPrompt(project.id, {
          name: promptData.name,
          content: promptData.content,
          category: promptData.category,
          usageCount: promptData.usageCount
  ...
  const deletePrompt = async (promptId) => {
    ...
    if (!project?.id || project.id.toString().startsWith('local-')) {
      // Delete from localStorage for local projects
      const existingPrompts = JSON.parse(localStorage.getItem(`promptManagement_${project?.id}`) || '[]');
      const updatedPrompts = existingPrompts.filter(p => p.id !== promptId);
      localStorage.setItem(`promptManagement_${project?.id}`, JSON.stringify(updatedPrompts));
      setPrompts(updatedPrompts);
      return;
    }

    try {
      await promptManagementService.deletePrompt(promptId);
      const updatedPrompts = prompts.filter(p => p.id !== promptId);
      setPrompts(updatedPrompts);
    } catch (error) {
      console.error("Failed to delete prompt:", error);
      alert("There was an error deleting your prompt. Please try again.");
    }
  };
  ...
  const handleOptimizePrompt = async (prompt) => {
    ...
    try {
      ...
      const optimized = await optimizePrompt(prompt.content, context);
  ...
  const groupedPrompts = filteredAndSortedPrompts.reduce((groups, prompt) => {
  ...
  const categoryConfig = {
    'Frontend': { color: 'bg-blue-100 text-blue-800 border-blue-200', icon: '🎨' },
    'Backend': { color: 'bg-green-100 text-green-800 border-green-200', icon: '⚙️' },
    'Database': { color: 'bg-purple-100 text-purple-800 border-purple-200', icon: '🗄️' },
    'API': { color: 'bg-orange-100 text-orange-800 border-orange-200', icon: '🔗' },
    'UI/UX': { color: 'bg-pink-100 text-pink-800 border-pink-200', icon: '✨' },
    'General': { color: 'bg-gray-100 text-gray-800 border-gray-200', icon: '📝' }
  };

  const categoryOrder = ['Frontend', 'Backend', 'Database', 'API', 'UI/UX', 'General'];
  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-start mb-8">
        <div>
          <h3 className="text-xl font-semibold text-gray-900">Prompt Management</h3>
          <p className="text-gray-600 text-sm">Organize, rate, and optimize your prompts in a Kanban board</p>
        </div>
        <button
          onClick={() => {
            setSelectedPrompt({
          ...
          className="flex items-center space-x-2 px-4 py-2 bg-vibe-cyan text-black rounded-lg hover:bg-vibe-cyan/90 transition-colors font-medium"
        >
          <Plus className="w-4 h-4" />
      ...
      <div className="bg-gray-50 rounded-xl p-4 mb-6">
        <div className="flex flex-wrap gap-4 items-center">
          ...
          <div className="flex-1 min-w-64">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-vibe-cyan focus:border-transparent"
              />
            </div>
          </div>
          ...
          <select
            ...
            className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-vibe-cyan focus:border-transparent"
          >
        ...
        <div className="text-center py-20">
          ...
          {!searchQuery && (
            <button
              ...
              className="px-6 py-3 bg-vibe-cyan text-black rounded-lg hover:bg-vibe-cyan/90 transition-colors font-semibold"
            >
              Create First Prompt
            </button>
          )}
        ...
        <div className="overflow-x-auto">
          <div className="flex space-x-6 min-w-max pb-4">
            {categoryOrder.map(category => {
              if (!groupedPrompts[category] || groupedPrompts[category].length === 0) {
                return null;
              }
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 mb-4">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center space-x-3">
                        ...
                        <span className={`px-2 py-1 text-xs font-medium rounded-full border ${categoryConfig[category]?.color || 'bg-gray-100 text-gray-800 border-gray-200'}`}>
                      ...
                      <button
                        ...
                        className="flex items-center justify-center w-8 h-8 bg-vibe-cyan text-black rounded-lg hover:bg-vibe-cyan/90 transition-colors"
                        title={`Add prompt to ${category}`}
                      >
                        <Plus className="w-4 h-4" />
                      </button>
                    </div>
      ...
      <PromptOptimizeModal
        ...
        onSaveOptimized={(optimizedContent) => {
          if (selectedPrompt) {
            savePrompt({
              ...selectedPrompt,
...
const PromptCard = ({ prompt, viewMode, onEdit, onDelete, onOptimize, getPriorityColor, copyToClipboard }) => {
            ...
            <div className="mb-3">
              <div className="flex items-center justify-between mb-1">
                ...
                <button
                  ...
                  className="flex items-center space-x-1 px-1 py-0.5 text-xs bg-gray-100 text-gray-600 rounded hover:bg-gray-200 transition-colors"
                >
              ...
              <div className="bg-gray-50 border border-gray-200 rounded p-2 max-h-20 overflow-y-auto">
                <pre className="text-xs text-gray-700 whitespace-pre-wrap font-mono line-clamp-3">{prompt.content}</pre>
              </div>
            </div>
          ...
          <div className="relative ml-2">
            ...
            {showActions && (
              <div className="absolute right-0 top-full mt-1 bg-white border border-gray-200 rounded-lg shadow-lg z-10 min-w-32">
                ...
                <button
                  onClick={() => { onOptimize(); setShowActions(false); }}
                  className="w-full px-3 py-2 text-left text-sm hover:bg-gray-50 flex items-center space-x-2"
                >
      ...
      <div className="space-y-3">
        ...
        <div>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-3 max-h-32 overflow-y-auto">
            <pre className="text-sm text-gray-700 whitespace-pre-wrap font-mono">{prompt.content}</pre>
          </div>
        </div>
        ...
        <div className="flex space-x-2 pt-2">
          <button
            onClick={onOptimize}
            className="flex-1 flex items-center justify-center space-x-1 px-3 py-2 text-xs bg-vibe-cyan text-black rounded-lg hover:bg-vibe-cyan/90 transition-colors font-medium"
          >
          ...
          <button
            onClick={onEdit}
            className="flex-1 flex items-center justify-center space-x-1 px-3 py-2 text-xs bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors font-medium"
          >
...
// Prompt Edit Modal
const PromptEditModal = ({ isOpen, onClose, prompt, onSave, priorityOptions }) => {
  ...
  const handleAddTag = () => {
    // Implement adding a new tag
  };

  const handleRemoveTag = (tag) => {
    // Implement removing a tag
  };
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      ...
      >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full h-64 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-vibe-cyan focus:border-transparent resize-none"
        ...
        <div className="flex justify-end space-x-3 p-6 border-t border-gray-200">
          ...
          <button
            onClick={handleSave}
            className="px-6 py-2 bg-vibe-cyan text-black rounded-lg hover:bg-vibe-cyan/90 transition-colors font-semibold"
          >
...
const PromptOptimizeModal = ({ isOpen, onClose, prompt, optimizedPrompt, isOptimizing, onSaveOptimized }) => {
  if (!isOpen) return null;
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      ...
      >
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-900">Optimize Prompt: {prompt?.name}</h2>
          <button onClick={onClose} className="text-gray-400 hover:text-gray-600">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
            </svg>
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            {/* Optimized Prompt */}
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Optimized Version</h3>
              {isOptimizing ? (
                <div className="bg-gray-50 rounded-lg p-8 border border-gray-200 flex flex-col items-center justify-center">
                  <motion.div
                    animate={{ rotate: 360 }}
                    transition={{ duration: 1, repeat: Infinity, ease: "linear" }}
                    className="w-8 h-8 border-2 border-vibe-cyan border-t-transparent rounded-full mb-4"
                  />
                ...
                <div className="space-y-4">
                  ...
                  <button
                    onClick={() => onSaveOptimized(optimizedPrompt)}
                    className="w-full px-4 py-2 bg-vibe-cyan text-black rounded-lg hover:bg-vibe-cyan/90 transition-colors font-semibold"
                  >
                ...
                <div className="bg-gray-50 rounded-lg p-8 border border-gray-200 text-center text-gray-500">
                  ...
                  <p>Click optimize to improve your prompt</p>
                </div>
              )}
            </div>
          </div>
