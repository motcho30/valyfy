...
- **Loading States**: Skeleton screens for code blocks
 ...
 This comprehensive analysis provides complete technical specifications for replicating the Cursor website's design system, visual aesthetics, and user experience patterns across any modern frontend implementation.`
    },
    {
      id: 8,
      company: 'Netflix',
      description: 'Streaming platform with bold cinematic design and dark theme',
      image: '/designinspoimages/netflix1.png',
      logo: '/designinspoimages/netflixlogo.png',
      images: [
        '/designinspoimages/netflix1.png',
        '/designinspoimages/netflix2.png',
        '/designinspoimages/netflix3.png',
        '/designinspoimages/netflix4.png'
      ],
      prompt: prefixText + `# Streaming Platform Landing Page - UI/UX Design Analysis
...
\`\`\`
 ...
 This comprehensive analysis provides all the technical details needed to replicate this streaming platform landing page design, including exact measurements, color codes, typography specifications, and implementation patterns across HTML, CSS, and JSX approaches.`
    },
    {
      id: 9,
      company: 'Jasper AI',
      description: 'AI content platform with clean modern SaaS design and vibrant theming',
      image: '/designinspoimages/jasper1.png',
      logo: '/designinspoimages/jasperlogo.png',
      images: [
        '/designinspoimages/jasper1.png',
        '/designinspoimages/jasper2.png',
        '/designinspoimages/jasper3.png',
        '/designinspoimages/jasper4.png',
        '/designinspoimages/jasper5.png',
        '/designinspoimages/jasper6.png',
        '/designinspoimages/jasper7.png'
      ],
      prompt: prefixText + `# AI Content Platform Landing Page - UI/UX Design Analysis
