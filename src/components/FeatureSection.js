...
const FeatureSection = ({ content, onDownload }) => {
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between mb-4">
        <div>
          <h3 className="text-xl font-semibold text-slate-800">Feature Analysis</h3>
          <p className="text-sm text-slate-600 mt-1">
            Extracted features and functionality overview from your codebase
          </p>
        </div>
